...
@ManagedBean(name="treeSelectionView2")
@ViewScoped
public class SelectionView2 implements Serializable {
    ...
    @ManagedProperty("#{documentService2}")
    private DocumentService2 service;
    ...
    public void setService(DocumentService2 service) {
